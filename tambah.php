        ...
        <div class="container">
          <div class="container2">
            ...
            <!-- <div class="row">
              ...
              <div class="col-75">
                <input type="number" name="menuid" placeholder="ID menu.."><br>
              </div>
            </div> -->
            <div class="row">
              <div class="col-25">
              ...
              <div class="col-75">
                <input type="text" name="nama" placeholder="Nama Product"><br>
              </div>
            </div>
            <div class="row">
              <div class="col-25">
              ...
              <div class="col-75">
                <input type="text" name="harga" placeholder="Harga Product"><br>
              </div>
            </div>
            <!-- <div class="row">
              <div class="col-25">
              ...
              <div class="col-75">
                <input type="text" name="keterangan" placeholder="Keterangan menu.."><br>
              </div>
            </div> -->
            <div class="row">
              <div class="col-25">
              ...
              <div class="col-75">
                  <input type="file" name="gambar" class="custom-file-upload" accept="image/*"><br>
                </div>
            </div>
            <div class="row">
              <div class="group">
