          ...
          <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarTogglerDemo01" aria-controls="navbarTogglerDemo01" aria-expanded="false" aria-label="Toggle navigation">
            ...
            <a class="navbar-brand" href="#">AdaSepatu</a>
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="admin.php">Product</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="tambah.php">Tambah Product</a>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <a style ="text-decoration: none; color: black; hover: white" href="edit.php?id=<?= $row["id"]; ?>" >Edit</button>
                                    <button type="button" class="btn btn-outline-danger">
                                    <a style ="text-decoration: none; color: orange; hover: white" href="delete.php?id=<?= $row["id"]; ?>" >Delete</a>
                                </button>
                                </div>
                            </div>
                        </div>
